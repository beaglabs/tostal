.PHONY: dev dev-api dev-gateway build test lint typecheck clean migrate setup train-facies train-dino train-segmenter evaluate
...
train-dino:
	python training/scripts/train_dino_classifier.py
